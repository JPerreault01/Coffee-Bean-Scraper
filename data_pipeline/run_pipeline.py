...
Usage:
    python data_pipeline/run_pipeline.py              # run all scrapers, resuming from checkpoint
    ...
    python data_pipeline/run_pipeline.py --fresh      # ignore state, start from zero
"""
...
def main():
    ...
    parser.add_argument("--fresh", action="store_true", help="Ignore existing state and start from zero")
    ...
    if args.fresh:
        logger.info("--fresh flag set: ignoring existing state files")
